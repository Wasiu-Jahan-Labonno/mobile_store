                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                    ...
                                    @if ( auth()->user()->profile_photo )
                                              <img src="{{ asset('uploads\profile_photo')  }}/{{ auth()->user()->profile_photo }}"   width="20" " >
                                          @else
                                          <img src="{{ asset('dashboard_asset/images/default_profile_photo.jpg') }}"  width="20" >
                                          @endif
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a href="{{ route('logout') }}" class="dropdown-item ai-icon" aria-labelledby="navbarDropdown">
        ...
        <div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    <li><a class="has-arrow ai-icon" href="{{ url('home') }}" >
							<span class="nav-text">Dashboard</span>
						</a>
                    </li>
                    <li><a class="has-arrow ai-icon" href="{{ url('users') }}" >
