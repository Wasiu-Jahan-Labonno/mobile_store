...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend_asset') }}/css/woocommerce.css">
...
<body>
                        ...
                        <div class="col col-lg-3 col-md-3 col-sm-12">
                            <div class="brand_logo">
                                <a class="brand_link" href="index.html">
                                    <img src="{{ asset('frontend_asset') }}/images/logo/logo_1x.png" srcset="{{ asset('frontend_asset') }}/images/logo/logo_2x.png 2x" alt>
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="row align-items-center">
                                ...
                                <div class="main_menu_inner collapse navbar-collapse" id="main_menu_dropdown">
                                    ...
                                    <ul class="main_menu_list ul_li">
                                     ...
                                     @guest
                                        ...
                                        @auth
                                        <li>
                                              <li><a class="nav-link" href="{{ url('/product')}}">Product List</a></li>
                                              <li><a class="nav-link" href="{{ route('login') }}">ADD Product</a></li>
                                        </li>
                        ...
                        <div class="col col-md-3">
                            <ul class="header_icons_group ul_li_right">
                                @guest
                                  <li>
                                    <a href="{{ route('account') }}">Login/Reg </a>
                                </li>
                                @endguest
  ...
  <!-- footer_section - start
                    ...
                    <div class="row">
                        <div class="col col-lg-4 col-md-6 col-sm-6">
                            <div class="footer_widget footer_about">
                                <div class="brand_logo">
                                    <a class="brand_link" href="index.html">
                                        <img src="{{ asset('frontend_asset') }}/images/logo/logo_1x.png" srcset="{{ asset('frontend_asset') }}/images/logo/logo_2x.png 2x" alt="logo_not_found">
                                    </a>
                                </div>
                        ...
                        <div class="col col-lg-4 col-md-6 col-sm-6">
                            <div class="footer_widget footer_contact">
                                ...
                                <ul class="store_btns_group ul_li">
                                    <li><a href="#!"><img src="{{ asset('frontend_asset') }}/images/app_store.png" alt="app_store"></a></li>
                                    <li><a href="#!"><img src="{{ asset('frontend_asset') }}/images/play_store.png" alt="play_store"></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col col-md-6">
                            <div class="payment_method">
                                <h4>Payment:</h4>
                                <img src="{{ asset('frontend_asset') }}/images/payments_icon.png" alt="image_not_found">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!-- google map  -->
    <script src="{{ asset('frontend_asset') }}/https://maps.googleapis.com/maps/api/js?key=AIzaSyDk2HrmqE4sWSei0XdKGbOMOHN3Mm2Bf-M&ver=2.1.6"></script>
